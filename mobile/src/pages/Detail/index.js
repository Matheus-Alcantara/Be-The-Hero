...
export default function Detail() {
  ...
  const message = `Hello ${incident.name}, i'm contacting you to help in the incident ${incident.title} with the value of ${Intl.NumberFormat('en-US', {style: 'currency', currency: 'USD'}).format(incident.value)}`;
